...
@Builder
@Entity
@Table(name = "rescue_requests", indexes = {
...
public class RescueRequestEntity {
        ...
        @JoinColumn(name = "citizen_id", nullable = false, foreignKey = @ForeignKey(name = "fk_rr_citizen"))
        ...
        @JoinColumn(name = "master_request_id", foreignKey = @ForeignKey(name = "fk_rr_master"))
